...
# Since the JSONC now uses the universal ~/ path, we just need to link it.
# This keeps your GitHub repository files clean and untouched.
ln -sf "$BRANDING_DIR/khaos-fastfetch.jsonc" ~/.config/fastfetch/config.jsonc

# --- 4. Bootloader Branding ---
...
echo "---------------------------------------------------"
echo "Success! KhaOS is fully deployed."